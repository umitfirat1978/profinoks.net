        ...
        <div className="mx-auto flex max-w-6xl items-center justify-end px-4 py-2 text-xs sm:text-[13px]">
          <div className="hidden items-center space-x-4 md:flex">
            ...
            <button
              ...
              className="bg-black/90 px-4 py-1.5 rounded-full text-white hover:bg-black transition-colors"
            >
          ...
          <div className="ml-4 flex flex-1 items-center justify-end space-x-3">
            <button
              type="button"
              onClick={toggleLang}
              className="bg-black/90 px-4 py-1.5 rounded-full flex items-center space-x-2 text-white hover:bg-black"
            >
