            ...
            <div className="mx-auto max-w-4xl px-4 py-12">
                ...
                <div className="prose prose-invert max-w-none space-y-8 text-white/80 leading-relaxed">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-white border-l-4 border-primary pl-4 uppercase tracking-wider">2. HİZMETİN KAPSAMI</h2>
                        <p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-white border-l-4 border-primary pl-4 uppercase tracking-wider">3. KULLANIM ŞARTLARI VE YÜKÜMLÜLÜKLER</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-white border-l-4 border-primary pl-4 uppercase tracking-wider">4. FİKRİ MÜLKİYET HAKLARI</h2>
                        <p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-white border-l-4 border-primary pl-4 uppercase tracking-wider">5. SORUMLULUK REDDİ (DISCLAIMER)</h2>
                        <ul className="list-none space-y-3">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-white border-l-4 border-primary pl-4 uppercase tracking-wider">6. GİZLİLİK VE KİŞİSEL VERİLER</h2>
                        <p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-white border-l-4 border-primary pl-4 uppercase tracking-wider">7. SÖZLEŞME DEĞİŞİKLİKLERİ</h2>
                        <p>
